...
image = Image.open('./data/WS-47012_WP.jpg')
...
with row6_1:
    html_data = """         
            <h1 style="color:white;text-align:center; font-family: "Lucida Console", Courier, monospace; text-decoration: underline; "><u>Currently Selected Data: </u></h1><br>    
                """
...
with row2_1:
    ...
    str_games =  str(unique_games_in_df) + " Matches"
    html_games = """\
                <h1 style="color:white;text-align:center; font-family: "Lucida Console", Courier, monospace; ">🏟️<br>{str_games} </h1><br>
                """.format(str_games=str_games)
    st.markdown(html_games, unsafe_allow_html=True)
...
with row2_2:
    ...
    if(unique_teams_in_df==1):
        t = " Team"
    str_teams =  str(unique_teams_in_df) + t
    html_teams = """\
                  <h1 style="color:white;text-align:center; font-family: "Lucida Console", Courier, monospace; ">🏃‍♂️<br>{str_teams} </h1><br>
                """.format(str_teams=str_teams)
...
with row2_3:
    ...
    html_goals = """\
                <h1 style="color:white;text-align:center; font-family: "Lucida Console", Courier, monospace; ">🥅<br>{str_goals} </h1><br>
                 """.format(str_goals=str_goals)
...
with row2_4:
    ...
    html_shots = """\
                <h1 style="color:white;text-align:center; font-family: "Lucida Console", Courier, monospace; ">⚽<br>{str_shots} </h1><br>
                """.format(str_shots=str_shots)
    st.markdown(html_shots, unsafe_allow_html=True)
...
with row12_1:
    ...
    html_mt = """\
                <h4 style="color:grey;text-align:center; font-family: "Lucida Console", Courier, monospace; ">Show match with the...</h1><br>
                """
    st.markdown(html_mt, unsafe_allow_html=True)
...
with row4_1:
    apt = """\
                <h4 style=" font-family: "Lucida Console", Courier, monospace; ">Analysis per Team</h4><br>
                """
    st.markdown(apt , unsafe_allow_html=True)
row5_spacer1, row5_1, row5_spacer2, row5_2, row5_spacer3  = st.columns((.2, 2.3, .4, 4.4, .2))
with row5_1:
    sst="""\
                <h6 style=" font-family: "Lucida Console", Courier, monospace; ">Investigate a variety of stats for each team. Which team scores the most goals per game? How does your team compare in terms of distance ran per game?</h6><br>
                """
    st.markdown(sst, unsafe_allow_html=True)    
...
with row6_1:
    apt1 = """\
                <h4 style=" font-family: "Lucida Console", Courier, monospace; ">Analysis per Season</h4><br>
                """
    st.markdown(apt1 , unsafe_allow_html=True)
row7_spacer1, row7_1, row7_spacer2, row7_2, row7_spacer3  = st.columns((.2, 2.3, .4, 4.4, .2))
with row7_1:
    sst1="""\
                <h6 style=" font-family: "Lucida Console", Courier, monospace; ">Investigate developments and trends. Which season had teams score the most goals? Has the amount of passes per games changed?</h6><br>
                """
    st.markdown(sst1, unsafe_allow_html=True)   
...
with row8_1:
    apt2 = """\
                <h4 style=" font-family: "Lucida Console", Courier, monospace; ">Analysis per Matchday</h4><br>
                """
    st.markdown(apt2 , unsafe_allow_html=True)  

row9_spacer1, row9_1, row9_spacer2, row9_2, row9_spacer3  = st.columns((.2, 2.3, .4, 4.4, .2))
with row9_1:
    sst2="""\
                <h6 style=" font-family: "Lucida Console", Courier, monospace; ">Investigate stats over the course of a season. At what point in the season do teams score the most goals? Do teams run less towards the end of the season?</h6><br>
                """
    st.markdown(sst2, unsafe_allow_html=True)      
...
with row10_1:
    apt3 = """\
                <h4 style=" font-family: "Lucida Console", Courier, monospace; ">Correlation of Game Stats</h4><br>
                """
    st.markdown(apt3 , unsafe_allow_html=True)  

row11_spacer1, row11_1, row11_spacer2, row11_2, row11_spacer3  = st.columns((.2, 2.3, .4, 4.4, .2))
with row11_1:
    sst3="""\
                <h6 style=" font-family: "Lucida Console", Courier, monospace; ">Investigate the correlation of attributes, but keep in mind correlation does not imply causation. Do teams that run more than their opponents also score more goals? Do teams that have more shots than their opponents have more corners?</h6><br>
                """
    st.markdown(sst3, unsafe_allow_html=True)   
